...
<div class="flex items-center justify-between mb-2 bg-gray-50 w-full max-w-xl mx-auto  rounded-md">
  <span class="text-gray-600 font-bold">Details</span>
  <button class="bg-indigo-500 text-white px-4 py-0.5 rounded hover:bg-indigo-500 focus:outline-none focus:ring focus:ring-indigo-400">Post</button>
</div>
